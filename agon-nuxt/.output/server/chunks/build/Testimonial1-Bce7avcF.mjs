...
import { _ as _imports_0, a as _imports_1$1 } from './virtual_public-B-ThRufd.mjs';
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_swiper_slide, { class: "p-10 transition-all duration-300 border-[10px] mx-[15px] hover:translate-y-[-2px] mt-[2px] border-bg-4" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<img class="h-full w-full object-cover max-w-[55px] max-h-[55px] mb-[22px]"${ssrRenderAttr("src", _imports_12)} alt="avatar"${_scopeId2}><p class="text-heading-6 font-chivo font-bold mb-[6px]"${_scopeId2}>Wade Warren</p><p class="text-sm font-bold mb-5 text-gray-700"${_scopeId2}>Louis Vuitton</p><p class="text-text text-gray-500"${_scopeId2}>Even factoring differences in body weight between children and adults into account.</p>`);
            } else {
              return [
                createVNode("img", {
        ...
        _push2(ssrRenderComponent(_component_swiper_slide, { class: "p-10 transition-all duration-300 border-[10px] mx-[15px] hover:translate-y-[-2px] mt-[2px] border-bg-6" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<img class="h-full w-full object-cover max-w-[55px] max-h-[55px] mb-[22px]"${ssrRenderAttr("src", _imports_1$1)} alt="avatar"${_scopeId2}><p class="text-heading-6 font-chivo font-bold mb-[6px]"${_scopeId2}>Wade Warren</p><p class="text-sm font-bold mb-5 text-gray-700"${_scopeId2}>Louis Vuitton</p><p class="text-text text-gray-500"${_scopeId2}>Even factoring differences in body weight between children and adults into account.</p>`);
            } else {
              return [
                createVNode("img", {
                  class: "h-full w-full object-cover max-w-[55px] max-h-[55px] mb-[22px]",
        ...
        _push2(ssrRenderComponent(_component_swiper_slide, { class: "p-10 transition-all duration-300 border-[10px] mx-[15px] hover:translate-y-[-2px] mt-[2px] border-bg-9" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<img class="h-full w-full object-cover max-w-[55px] max-h-[55px] mb-[22px]"${ssrRenderAttr("src", _imports_11)} alt="avatar"${_scopeId2}><p class="text-heading-6 font-chivo font-bold mb-[6px]"${_scopeId2}>Wade Warren</p><p class="text-sm font-bold mb-5 text-gray-700"${_scopeId2}>Louis Vuitton</p><p class="text-text text-gray-500"${_scopeId2}>Even factoring differences in body weight between children and adults into account.</p>`);
            } else {
              return [
                createVNode("img", {
                  class: "h-full w-full object-cover max-w-[55px] max-h-[55px] mb-[22px]",
...
//# sourceMappingURL=Testimonial1-Bce7avcF.mjs.map
