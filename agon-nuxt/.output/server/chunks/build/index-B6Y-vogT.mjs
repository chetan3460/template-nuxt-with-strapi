...
import { u as useHead, _ as _export_sfc, a as _imports_1$3 } from './server.mjs';
import { p as publicAssetsURL } from '../routes/renderer.mjs';
import { _ as _imports_0$3, a as _imports_1$4, b as _imports_2$3, c as _imports_3$1, d as _imports_4, e as _imports_5 } from './virtual_public-DSob6RUo.mjs';
...
import { _ as _imports_2$5, a as _imports_4$3, b as _imports_6 } from './virtual_public-DL0aym9q.mjs';
...
import { _ as _imports_1$6, a as _imports_2$6 } from './virtual_public-FjLltpP8.mjs';
import { _ as __nuxt_component_0$2 } from './Testimonial1-Bce7avcF.mjs';
import { _ as _imports_0$9, a as _imports_1$7 } from './virtual_public-BzD1hskI.mjs';
import { _ as _imports_0$2 } from './virtual_public-BjNzXJKo.mjs';
import { _ as _imports_1$2, a as _imports_2$2 } from './virtual_public-BjCH7PF9.mjs';
import { _ as _imports_2$7 } from './virtual_public-BYCduXmb.mjs';
...
const _imports_1$1 = publicAssetsURL("/assets/images/hero-1.png");
const _imports_2$1 = publicAssetsURL("/assets/images/video-bg.png");
const _sfc_main$a = {
  components: {
    ModalVideo
  },
...
function _sfc_ssrRender$8(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><div class="full-width banner-hero bg-orange-100 banner-1"><div class="px-[12px] md:px-[36px] xl:px-0 mt-0 z-10 relative mx-auto py-[60px] max-w-[1320px] lg:flex lg:items-center"><div class="flex-1"><h1 class="font-chivo font-bold lg:text-display-2 md:text-[64px] md:leading-[70px] sm:text-[50px] sm:leading-[58px] text-[40px] leading-[48px] mb-[40px]">We are<span class="text-green-900">\xA0awesome team\xA0</span><span>for your business dream</span></h1><p class="text-quote md:text-lead-lg text-gray-500 pr-[40px] lg:pr-[60px] mb-[40px]">Integrated workflow designed for product teams. We create world-class development and branding</p><div class="flex items-center justify-start"><button type="button">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span class="block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold"${_scopeId}>Get Start</span><i${_scopeId}><img class="ml-[7px] w-[12px] filter-white group-hover:filter-black"${ssrRenderAttr("src", _imports_1$3)} alt="arrow right icon"${_scopeId}></i>`);
      } else {
        return [
          createVNode("span", { class: "block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold" }, "Get Start"),
          createVNode("i", null, [
            createVNode("img", {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Learn More <i${_scopeId}><img class="ml-[7px] w-[12px]"${ssrRenderAttr("src", _imports_1$3)} alt="arrow right icon"${_scopeId}></i>`);
      } else {
        return [
  ...
  _push(`</div></div><div class="hidden relative flex-1 h-auto self-stretch lg:block"><div class="absolute w-full left-20 animate-hero-thumb-sm-animation bottom-[-60px] max-w-[526px]"><img class="h-full w-full object-cover"${ssrRenderAttr("src", _imports_1$1)} alt="Agon"></div><div class="absolute opacity-80 animate-float max-w-[176px] bottom-[10%] -translate-x-1/3"><div class="relative bg-green-900 bg-opacity-80 rounded-2xl grid place-items-center"><img class="h-full w-full object-cover"${ssrRenderAttr("src", _imports_2$1)} alt="Agon"><p class="text-heading-4 absolute text-white font-chivo font-bold ml-[49px]">Watch intro video</p><button class="rounded-full bg-white grid place-items-center absolute play-video w-[64px] h-[64px] left-[-15%]"><img${ssrRenderAttr("src", _imports_3)} alt="play button" width="15"></button></div></div></div></div></div>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$8]]);
const _sfc_main$9 = {};
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span class="block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold"${_scopeId}>Learn More</span><i${_scopeId}><img class="ml-[7px] w-[12px] filter-black group-hover:filter-white"${ssrRenderAttr("src", _imports_1$3)} alt="arrow right icon"${_scopeId}></i>`);
      } else {
        return [
  ...
  _push(`</button></div><div class="relative lg:w-1/2"><img class="h-full w-full object-cover"${ssrRenderAttr("src", _imports_2$4)} alt="Agon"><img class="absolute top-0 right-0"${ssrRenderAttr("src", _imports_2)} alt="pattern"><button class="rounded-full bg-white grid place-items-center absolute play-video w-[135px] h-[135px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:left-0"><img${ssrRenderAttr("src", _imports_3)} alt="play button" width="30"></button></div></div><div class="${ssrRenderClass([{ "!hidden": $data.selectedTab !== 4 }, "tab-content lg:gap-[30px] lg:flex bg-bg-6 social-network"])}" style="${ssrRenderStyle($data.selectedTab === 4 ? null : { display: "none" })}"><div class="p-5 md:p-[60px] lg:w-1/2"><h2 class="font-bold font-chivo text-[28px] leading-[32px] md:text-heading-2 mb-[30px]">Subscribe our newsletter to get gift </h2><p class="text-excerpt mb-[40px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p><button type="button">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    class: "flex items-center z-10 relative transition-all duration-200 group px-[22px] py-[15px] lg:px-[32px] lg:py-[22px] rounded-[50px] bg-white text-gray-900 hover:bg-gray-900 hover:text-white w-fit",
    to: "#"
  }, {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "px-[12px] md:px-[36px] xl:px-0 mt-[70px]" }, _attrs))}><div class="items-center justify-between md:flex mb-[30px] md:mb-[80px]"><div><h2 class="text-gray-900 font-bold font-chivo mb-5 text-[35px] leading-[44px] md:text-[46px] md:leading-[52px] lg:text-heading-1 md:mb-[30px] max-w-[725px]">Our Happy Customers</h2><p class="text-quote md:text-lead-lg text-gray-600">Know about our clients, we are a woldwide corporate brand</p></div><div class="flex items-center gap-5 self-end"><div class="tap1 place-items-center border border-gray-200 bg-gray-100 rounded-full cursor-pointer group transition-colors duration-200 w-[48px] xl:w-[64px] h-[48px] xl:h-[64px] hover:bg-gray-900 feedback-prev grid"><img class="group-hover:filter-white"${ssrRenderAttr("src", _imports_0$9)} alt="control icon button"></div><div class="tan1 place-items-center border border-gray-200 bg-gray-100 rounded-full cursor-pointer group transition-colors duration-200 w-[48px] xl:w-[64px] h-[48px] xl:h-[64px] hover:bg-gray-900 feedback-next grid"><img class="group-hover:filter-white"${ssrRenderAttr("src", _imports_1$7)} alt="control icon button"></div></div></div>`);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span class="block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold"${_scopeId}>View More</span><i${_scopeId}><img class="ml-[7px] w-[12px] filter-white group-hover:filter-black"${ssrRenderAttr("src", _imports_1$3)} alt="arrow right icon"${_scopeId}></i>`);
      } else {
        return [
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="block text-inherit w-full h-full rounded-md text-lg font-chivo font-semibold"${_scopeId}>Get Started</span><i${_scopeId}><img class="ml-[7px] w-[12px] filter-white group-hover:filter-black"${ssrRenderAttr("src", _imports_1$3)} alt="arrow right icon"${_scopeId}></i>`);
          } else {
            return [
...
//# sourceMappingURL=index-B6Y-vogT.mjs.map
