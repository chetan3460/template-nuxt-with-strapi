...
import { _ as _imports_2 } from './virtual_public-BYCduXmb.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span class="block text-inherit w-full h-full rounded-[50px] text-heading-6 font-chivo font-semibold"${_scopeId}>Apply Now</span><i${_scopeId}><img class="ml-[7px] w-[12px] filter-white group-hover:filter-white"${ssrRenderAttr("src", _imports_1)} alt="arrow right icon"${_scopeId}></i>`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span class="block text-inherit w-full h-full rounded-[50px] text-heading-6 font-chivo font-semibold"${_scopeId}>Contact Us</span><i${_scopeId}><img class="ml-[7px] w-[12px] filter-black group-hover:filter-white"${ssrRenderAttr("src", _imports_1)} alt="arrow right icon"${_scopeId}></i>`);
      } else {
        return [
...
//# sourceMappingURL=index-C4TQr-8S.mjs.map
