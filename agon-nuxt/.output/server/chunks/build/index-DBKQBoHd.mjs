...
import { M as ModalVideo, _ as _imports_3$2 } from './virtual_public-nLEhPKKc.mjs';
import { _ as _imports_8$1, a as __nuxt_component_0$2 } from './Testimonial1-CcdhIxve.mjs';
import { _ as _imports_0$2, a as _imports_1, b as _imports_2$2 } from './virtual_public-C3LypWMC.mjs';
import { _ as _imports_0$3, a as _imports_3$3, b as _imports_5$1 } from './virtual_public-7ocew1z3.mjs';
import { Autoplay, Pagination, Navigation } from 'swiper/modules';
import { Swiper, SwiperSlide } from 'swiper/vue';
import { _ as _imports_0$4, a as _imports_1$1 } from './virtual_public-BzD1hskI.mjs';
import { _ as _imports_1$2, a as _imports_2$3, b as _imports_3$4 } from './virtual_public-LzzktlNG.mjs';
...
const _imports_3$1 = publicAssetsURL("/assets/images/thumbnail-13.png");
const _sfc_main$8 = {};
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span class="block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold"${_scopeId}>Join Our Team</span><i${_scopeId}><img class="ml-[7px] w-[12px] filter-white group-hover:filter-black"${ssrRenderAttr("src", _imports_0$1)} alt="arrow right icon"${_scopeId}></i>`);
      } else {
        return [
  ...
  _push(`<i><img class="ml-[7px] w-[12px]"${ssrRenderAttr("src", _imports_0$1)} alt="arrow right icon"></i></div></div><div class="hidden relative lg:block"><img class="animate-float absolute rounded-2xl max-w-[240px] max-h-[340px] bottom-[-12%] left-[-50%]"${ssrRenderAttr("src", _imports_2$1)} alt="Agon"><img class="animate-hero-thumb-sm-animation max-w-[512px] max-h-[689px]"${ssrRenderAttr("src", _imports_3$1)} alt="Agon"></div></div></div><!--]-->`);
}
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span class="block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold"${_scopeId}>Learn More</span><i${_scopeId}><img class="ml-[7px] w-[12px] filter-black group-hover:filter-white"${ssrRenderAttr("src", _imports_0$1)} alt="arrow right icon"${_scopeId}></i>`);
      } else {
        return [
...
const _imports_3 = publicAssetsURL("/assets/images/icons/icon-facebook-gray.svg");
const _imports_4 = publicAssetsURL("/assets/images/icons/icon-instagram-gray.svg");
const _imports_5 = publicAssetsURL("/assets/images/icons/icon-twitter-gray.svg");
const _imports_6 = publicAssetsURL("/assets/images/icons/icon-linkedin-gray.svg");
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_NuxtLink = __nuxt_component_0$1;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "px-[12px] md:px-[36px] xl:px-0 mt-[70px] lg:mt-[150px]" }, _attrs))}><div class="items-center justify-between md:flex mb-[80px] md:mb-[90px]"><div class="mb-8"><h2 class="text-gray-900 font-bold font-chivo mb-5 text-[35px] leading-[44px] md:text-[46px] md:leading-[52px] lg:text-heading-1 md:mb-[30px] max-w-[725px]"> Our Team</h2><p class="text-quote md:text-lead-lg text-gray-600">Decades of experience in design and development </p></div><div class="flex items-center gap-5"><div class="t1p place-items-center border border-gray-200 bg-gray-100 rounded-full cursor-pointer group transition-colors duration-200 w-[48px] xl:w-[64px] h-[48px] xl:h-[64px] hover:bg-gray-900 team-prev grid"><img class="group-hover:filter-white"${ssrRenderAttr("src", _imports_0$4)} alt="control icon button"></div><div class="t1n place-items-center border border-gray-200 bg-gray-100 rounded-full cursor-pointer group transition-colors duration-200 w-[48px] xl:w-[64px] h-[48px] xl:h-[64px] hover:bg-gray-900 team-next grid"><img class="group-hover:filter-white"${ssrRenderAttr("src", _imports_1$1)} alt="control icon button"></div></div></div>`);
            ...
            if (_push3) {
              ...
              _push3(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<img class="h-full w-full object-cover"${ssrRenderAttr("src", _imports_3)} alt="facebook icon"${_scopeId3}>`);
                  } else {
                    return [
                      createVNode("img", {
              ...
              _push3(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<img class="h-full w-full object-cover"${ssrRenderAttr("src", _imports_4)} alt="instagram icon"${_scopeId3}>`);
                  } else {
                    return [
                      createVNode("img", {
                        class: "h-full w-full object-cover",
              ...
              _push3(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<img class="h-full w-full object-cover"${ssrRenderAttr("src", _imports_5)} alt="twitter icon"${_scopeId3}>`);
                  } else {
                    return [
                      createVNode("img", {
                        class: "h-full w-full object-cover",
              ...
              _push3(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<img class="h-full w-full object-cover"${ssrRenderAttr("src", _imports_6)} alt="linkedin icon"${_scopeId3}>`);
                  } else {
                    return [
                      createVNode("img", {
                        class: "h-full w-full object-cover",
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span class="block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold"${_scopeId}>View More</span><i${_scopeId}><img class="ml-[7px] w-[12px] filter-white group-hover:filter-black"${ssrRenderAttr("src", _imports_0$1)} alt="arrow right icon"${_scopeId}></i>`);
      } else {
        return [
...
//# sourceMappingURL=index-DBKQBoHd.mjs.map
