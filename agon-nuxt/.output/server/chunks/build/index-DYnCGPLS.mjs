...
import { _ as _imports_0$2 } from './virtual_public-Dje3ZdMY.mjs';
import { _ as _imports_1$2, a as _imports_2$1 } from './virtual_public-FjLltpP8.mjs';
...
const _imports_0 = publicAssetsURL("/assets/images/faqs-1-bg.png");
const _sfc_main$5 = {};
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  _push(`<!--[--><img class="h-full w-full object-cover absolute top-0 left-0 z-0 md:!object-fill max-h-[500px] lg:max-h-[600px]"${ssrRenderAttr("src", _imports_0)} alt="background"><div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] z-10 relative lg:mt-[84px]"><div class="text-center text-white"><h1 class="font-chivo font-bold lg:text-display-3 md:text-[45px] md:leading-[52px] text-[35px] leading-[42px] text-white mb-[45px]">We are here to help you</h1><form class="mt-[30px] mx-auto max-w-[550px] mb-[45px]" action="/"><div class="bg-white flex items-center justify-between p-3 rounded-[55px]"><input class="ml-[25px]" type="text" placeholder="Enter your mail ..."><button class="rounded-full bg-green-900 grid place-items-center w-[56px] h-[56px]" type="submit"><img class="filter-white"${ssrRenderAttr("src", _imports_1$1)} alt=""></button></div></form><p class="text-lead font-bold">We are collect your searching keywords to improve our services</p></div></div><!--]-->`);
}
const _sfc_setup$5 = _sfc_main$5.setup;
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/Faqs1/Section1.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$3]]);
const _sfc_main$4 = {};
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "px-[12px] md:px-[36px] xl:px-0 mt-[70px] lg:mt-[150px]" }, _attrs))}><div class="relative px-[12px] py-[70px] rounded-[50px]"><div class="text-center relative mb-[70px] md:mb-[90px]"><h2 class="font-bold font-chivo mx-auto text-[35px] leading-[44px] md:text-[46px] md:leading-[52px] lg:text-heading-1 text-gray-900 mb-5 md:mb-[30px] max-w-[725px]">Or choose a category</h2><p class="text-quote md:text-lead-lg text-gray-600 mx-auto md:w-[51ch]">Aliquam a augue suscipit, luctus neque purus ipsum neque dolor primis a libero tempus, blandit and cursus varius and magnis sapien</p></div><div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-[30px]"><div class="rounded-2xl py-[20px] px-[24px] md:py-[43px] md:px-[63px] md:mx-5 transition-all duration-300 hover:translate-y-[-3px] bg-bg-2"><img class="h-full w-full object-cover mb-[30px] max-w-[50px] max-h-[50px]"${ssrRenderAttr("src", _imports_0$2)} alt="icon"><h3 class="font-chivo font-bold text-[18px] md:text-heading-5 mb-[20px]">Market research</h3><p class="text-text text-gray-600">One make creepeth, man bearing theira firmament.</p></div><div class="rounded-2xl py-[20px] px-[24px] md:py-[43px] md:px-[63px] md:mx-5 transition-all duration-300 hover:translate-y-[-3px] bg-bg-2"><img class="h-full w-full object-cover mb-[30px] max-w-[50px] max-h-[50px]"${ssrRenderAttr("src", _imports_1$2)} alt="icon"><h3 class="font-chivo font-bold text-[18px] md:text-heading-5 mb-[20px]">Strategic Consulting</h3><p class="text-text text-gray-600">One make creepeth, man bearing theira firmament.</p></div><div class="rounded-2xl py-[20px] px-[24px] md:py-[43px] md:px-[63px] md:mx-5 transition-all duration-300 hover:translate-y-[-3px] bg-bg-2"><img class="h-full w-full object-cover mb-[30px] max-w-[50px] max-h-[50px]"${ssrRenderAttr("src", _imports_2$1)} alt="icon"><h3 class="font-chivo font-bold text-[18px] md:text-heading-5 mb-[20px]">Cognitive Solution</h3><p class="text-text text-gray-600">One make creepeth, man bearing theira firmament.</p></div></div></div></div>`);
}
const _sfc_setup$4 = _sfc_main$4.setup;
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/Faqs1/Section2.vue");
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "gap-6 px-5 lg:flex xl:gap-[50px]" }, _attrs))}><div class="flex-1 mb-[40px]"><div class="mb-[22px]"><h2 class="text-gray-900 font-bold font-chivo mb-5 text-[35px] leading-[44px] md:text-[46px] md:leading-[52px] lg:text-heading-1 md:mb-[30px] max-w-[725px]">Frequently asked questions</h2><p class="text-quote md:text-lead-lg text-gray-600"></p></div><p class="text-text text-gray-600 mb-[40px]">Feeling inquisitive? Have a read through some of our FAQs or contact our supporters for help</p><div class="flex flex-col lg:max-w-[303px] md:gap-[35px] lg:mb-[48px]"><div class="mb-[30px] lg:mb-0"><div class="flex items-center mb-[17px]"><img class="mr-[9px]"${ssrRenderAttr("src", _imports_0$3)} alt="leaf icon"><h4 class="text-heading-6 font-chivo font-bold">Boost your sale</h4></div><p class="text-excerpt text-gray-600">The latest design trends meet hand-crafted templates.</p></div><div class="mb-[30px] lg:mb-0"><div class="flex items-center mb-[17px]"><img class="mr-[9px]"${ssrRenderAttr("src", _imports_0$3)} alt="leaf icon"><h4 class="text-heading-6 font-chivo font-bold">Introducing New Features</h4></div><p class="text-excerpt text-gray-600">The latest design trends meet hand-crafted templates.</p></div></div><div class="flex items-center"><button type="button">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span class="block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold"${_scopeId}>Contact Us</span><i${_scopeId}><img class="ml-[7px] w-[12px] filter-white group-hover:filter-black"${ssrRenderAttr("src", _imports_1$1)} alt="arrow right icon"${_scopeId}></i>`);
      } else {
        return [
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/Faqs1/Section3.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/Faqs1/Section4.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/Faqs1/Section5.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SectionsFaqs1Section1 = __nuxt_component_0;
      const _component_SectionsFaqs1Section2 = __nuxt_component_1;
      const _component_SectionsFaqs1Section3 = __nuxt_component_2;
      const _component_SectionsFaqs1Section4 = _sfc_main$2;
      const _component_SectionsFaqs1Section5 = __nuxt_component_4;
...
//# sourceMappingURL=index-DYnCGPLS.mjs.map
