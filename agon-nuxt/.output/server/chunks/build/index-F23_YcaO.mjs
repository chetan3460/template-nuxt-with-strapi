...
import { u as useHead, c as useNuxtApp, a as _imports_0$2, _ as _export_sfc, f as fetchDefaults, d as asyncDataDefaults, e as createError } from './server.mjs';
import { _ as _imports_3$1, M as ModalVideo } from './virtual_public-nLEhPKKc.mjs';
import { p as hash } from '../nitro/nitro.mjs';
import { _ as _imports_0$2$1, a as _imports_1$1, b as _imports_2$1$1, c as _imports_3$2, d as _imports_4$1, e as _imports_5, f as _imports_0$1$1, g as _imports_0$5, h as _imports_1$4, i as _imports_2$4 } from './virtual_public-B7jNupp5.mjs';
import { _ as _imports_0$3 } from './virtual_public-edIg6YOR.mjs';
import { p as publicAssetsURL } from '../routes/renderer.mjs';
import { _ as _imports_1$2, a as _imports_2$2, b as _imports_3$3 } from './virtual_public-LzzktlNG.mjs';
import { _ as _imports_8, a as __nuxt_component_0$1 } from './Testimonial1-CcdhIxve.mjs';
import { _ as _imports_0$4, a as _imports_3$4, b as _imports_5$1 } from './virtual_public-7ocew1z3.mjs';
import { _ as _imports_2$3, a as _imports_4$2, b as _imports_6 } from './virtual_public-DL0aym9q.mjs';
import { _ as _imports_1$3, a as _imports_2$5 } from './virtual_public-nUl_eC9X.mjs';
import { Autoplay, Pagination, Navigation } from 'swiper/modules';
import { Swiper, SwiperSlide } from 'swiper/vue';
import { _ as _imports_0$6, a as _imports_1$5 } from './virtual_public-BzD1hskI.mjs';
import 'unhead';
...
import 'devalue';
import '@unhead/ssr';
import './virtual_public-CpP-F1uf.mjs';
...
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", _imports_0$2$1)} alt="partner logo"${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: _imports_0$2$1,
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", _imports_1$1)} alt="partner logo"${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: _imports_1$1,
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", _imports_2$1$1)} alt="partner logo"${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: _imports_2$1$1,
...
const _imports_2$1 = publicAssetsURL("/assets/images/icons/pattern-3.svg");
const _imports_7 = publicAssetsURL("/assets/images/thumbnail-19.png");
const _sfc_main$8 = {
  components: {
    ModalVideo
  },
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span class="block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold"${_scopeId}>Learn More</span><i${_scopeId}><img class="ml-[7px] w-[12px] filter-black group-hover:filter-white"${ssrRenderAttr("src", _imports_0$2)} alt="arrow right icon"${_scopeId}></i>`);
      } else {
        return [
  ...
  _push(`</button></div><div class="relative lg:w-1/2"><img class="h-full w-full object-cover"${ssrRenderAttr("src", _imports_0$3)} alt="Agon"><img class="absolute top-0 right-0"${ssrRenderAttr("src", _imports_2$1)} alt="pattern"><button class="rounded-full bg-white grid place-items-center absolute play-video w-[135px] h-[135px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:left-0"><img${ssrRenderAttr("src", _imports_3$1)} alt="play button" width="30"></button></div></div><div class="${ssrRenderClass([{ "!hidden": $data.selectedTab !== 1 }, "tab-content lg:gap-[30px] lg:flex bg-bg-3 development"])}" style="${ssrRenderStyle($data.selectedTab === 1 ? null : { display: "none" })}"><div class="p-5 md:p-[60px] lg:w-1/2"><h2 class="font-bold font-chivo text-[28px] leading-[32px] md:text-heading-2 mb-[30px]">Design Studios That Everyone Should Know </h2><p class="text-excerpt mb-[40px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p><button type="button">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    class: "flex items-center z-10 relative transition-all duration-200 group px-[22px] py-[15px] lg:px-[32px] lg:py-[22px] rounded-[50px] bg-white text-gray-900 hover:bg-gray-900 hover:text-white w-fit",
    to: "#"
  }, {
  ...
  _push(`</button></div><div class="relative lg:w-1/2"><img class="h-full w-full object-cover"${ssrRenderAttr("src", _imports_1$2)} alt="Agon"><img class="absolute top-0 right-0"${ssrRenderAttr("src", _imports_2$1)} alt="pattern"><button class="rounded-full bg-white grid place-items-center absolute play-video w-[135px] h-[135px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:left-0"><img${ssrRenderAttr("src", _imports_3$1)} alt="play button" width="30"></button></div></div><div class="${ssrRenderClass([{ "!hidden": $data.selectedTab !== 2 }, "tab-content lg:gap-[30px] lg:flex bg-bg-4 animation"])}" style="${ssrRenderStyle($data.selectedTab === 2 ? null : { display: "none" })}"><div class="p-5 md:p-[60px] lg:w-1/2"><h2 class="font-bold font-chivo text-[28px] leading-[32px] md:text-heading-2 mb-[30px]">We can blend colors multiple ways </h2><p class="text-excerpt mb-[40px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p><button type="button">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    class: "flex items-center z-10 relative transition-all duration-200 group px-[22px] py-[15px] lg:px-[32px] lg:py-[22px] rounded-[50px] bg-white text-gray-900 hover:bg-gray-900 hover:text-white w-fit",
    to: "#"
  }, {
  ...
  _push(`</button></div><div class="relative lg:w-1/2"><img class="h-full w-full object-cover"${ssrRenderAttr("src", _imports_2$2)} alt="Agon"><img class="absolute top-0 right-0"${ssrRenderAttr("src", _imports_2$1)} alt="pattern"><button class="rounded-full bg-white grid place-items-center absolute play-video w-[135px] h-[135px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:left-0"><img${ssrRenderAttr("src", _imports_3$1)} alt="play button" width="30"></button></div></div><div class="${ssrRenderClass([{ "!hidden": $data.selectedTab !== 3 }, "tab-content lg:gap-[30px] lg:flex bg-bg-5 user-exp"])}" style="${ssrRenderStyle($data.selectedTab === 3 ? null : { display: "none" })}"><div class="p-5 md:p-[60px] lg:w-1/2"><h2 class="font-bold font-chivo text-[28px] leading-[32px] md:text-heading-2 mb-[30px]">Choose The Best Plan That&#39;s For You </h2><p class="text-excerpt mb-[40px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p><button type="button">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    class: "flex items-center z-10 relative transition-all duration-200 group px-[22px] py-[15px] lg:px-[32px] lg:py-[22px] rounded-[50px] bg-white text-gray-900 hover:bg-gray-900 hover:text-white w-fit",
    to: "#"
  }, {
  ...
  _push(`</button></div><div class="relative lg:w-1/2"><img class="h-full w-full object-cover"${ssrRenderAttr("src", _imports_3$3)} alt="Agon"><img class="absolute top-0 right-0"${ssrRenderAttr("src", _imports_2$1)} alt="pattern"><button class="rounded-full bg-white grid place-items-center absolute play-video w-[135px] h-[135px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:left-0"><img${ssrRenderAttr("src", _imports_3$1)} alt="play button" width="30"></button></div></div><div class="${ssrRenderClass([{ "!hidden": $data.selectedTab !== 4 }, "tab-content lg:gap-[30px] lg:flex bg-bg-6 social-network"])}" style="${ssrRenderStyle($data.selectedTab === 4 ? null : { display: "none" })}"><div class="p-5 md:p-[60px] lg:w-1/2"><h2 class="font-bold font-chivo text-[28px] leading-[32px] md:text-heading-2 mb-[30px]">Subscribe our newsletter to get gift </h2><p class="text-excerpt mb-[40px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p><button type="button">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    class: "flex items-center z-10 relative transition-all duration-200 group px-[22px] py-[15px] lg:px-[32px] lg:py-[22px] rounded-[50px] bg-white text-gray-900 hover:bg-gray-900 hover:text-white w-fit",
    to: "#"
  }, {
  ...
  _push(`</button></div><div class="relative lg:w-1/2"><img class="h-full w-full object-cover"${ssrRenderAttr("src", _imports_7)} alt="Agon"><img class="absolute top-0 right-0"${ssrRenderAttr("src", _imports_2$1)} alt="pattern"><button class="rounded-full bg-white grid place-items-center absolute play-video w-[135px] h-[135px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:left-0"><img${ssrRenderAttr("src", _imports_3$1)} alt="play button" width="30"></button></div></div><div class="${ssrRenderClass([{ "!hidden": $data.selectedTab !== 5 }, "tab-content lg:gap-[30px] lg:flex bg-bg-7 marketing"])}" style="${ssrRenderStyle($data.selectedTab === 5 ? null : { display: "none" })}"><div class="p-5 md:p-[60px] lg:w-1/2"><h2 class="font-bold font-chivo text-[28px] leading-[32px] md:text-heading-2 mb-[30px]">Ready to get started? Create and Account </h2><p class="text-excerpt mb-[40px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p><button type="button">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    class: "flex items-center z-10 relative transition-all duration-200 group px-[22px] py-[15px] lg:px-[32px] lg:py-[22px] rounded-[50px] bg-white text-gray-900 hover:bg-gray-900 hover:text-white w-fit",
    to: "#"
  }, {
  ...
  _push(`</button></div><div class="relative lg:w-1/2"><img class="h-full w-full object-cover"${ssrRenderAttr("src", _imports_8)} alt="Agon"><img class="absolute top-0 right-0"${ssrRenderAttr("src", _imports_2$1)} alt="pattern"><button class="rounded-full bg-white grid place-items-center absolute play-video w-[135px] h-[135px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 lg:left-0"><img${ssrRenderAttr("src", _imports_3$1)} alt="play button" width="30"></button></div></div></div>`);
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</button><img class="absolute bottom-0 right-0 z-0 max-w-[90px] md:max-w-[144px] max-h-[90px] md:max-h-[144px] translate-x-[20%] translate-y-[20%] xl:translate-x-0 xl:translate-y-0"${ssrRenderAttr("src", _imports_4$2)} alt="icon"></div><div class="rounded-2xl p-[30px] md:py-[53px] md:px-[48px] relative mb-5 flex flex-col justify-between transition-all duration-300 bg-bg-2 hover:translate-y-[-2px]"><div><img class="h-full w-full object-cover mb-[30px] max-w-[80px] max-h-[80px]"${ssrRenderAttr("src", _imports_5$1)} alt="icon"><h2 class="font-bold font-chivo text-[28px] leading-[32px] md:text-heading-2 mb-[30px]">Social Media</h2><p class="text-excerpt text-gray-600 mb-[30px]">You are always welcome to visit our little den. Professional in teir craft! All products were super amazing with strong attension to details, comps and overall vibe.</p></div><button type="button">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    class: "flex items-center z-10 relative transition-all duration-200 group px-[22px] py-[15px] lg:px-[32px] lg:py-[22px] rounded-[50px] bg-white text-gray-900 hover:bg-gray-900 hover:text-white w-fit hover:translate-y-[-3px]",
    to: "#"
  }, {
...
function _sfc_ssrRender$2(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "px-[12px] md:px-[36px] xl:px-0 mt-[70px]" }, _attrs))}><div class="items-center justify-between md:flex mb-[30px] md:mb-[80px]"><div><h2 class="text-gray-900 font-bold font-chivo mb-5 text-[35px] leading-[44px] md:text-[46px] md:leading-[52px] lg:text-heading-1 md:mb-[30px] max-w-[725px]">Our Happy Customers</h2><p class="text-quote md:text-lead-lg text-gray-600">Know about our clients, we are a woldwide corporate brand</p></div><div class="flex items-center gap-5 self-end"><div class="tap1 place-items-center border border-gray-200 bg-gray-100 rounded-full cursor-pointer group transition-colors duration-200 w-[48px] xl:w-[64px] h-[48px] xl:h-[64px] hover:bg-gray-900 feedback-prev grid"><img class="group-hover:filter-white"${ssrRenderAttr("src", _imports_0$6)} alt="control icon button"></div><div class="tan1 place-items-center border border-gray-200 bg-gray-100 rounded-full cursor-pointer group transition-colors duration-200 w-[48px] xl:w-[64px] h-[48px] xl:h-[64px] hover:bg-gray-900 feedback-next grid"><img class="group-hover:filter-white"${ssrRenderAttr("src", _imports_1$5)} alt="control icon button"></div></div></div>`);
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span class="block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold"${_scopeId}>View More</span><i${_scopeId}><img class="ml-[7px] w-[12px] filter-white group-hover:filter-black"${ssrRenderAttr("src", _imports_0$2)} alt="arrow right icon"${_scopeId}></i>`);
      } else {
        return [
...
const _imports_2 = publicAssetsURL("/assets/images/icons/icon-tick.svg");
const _imports_3 = publicAssetsURL("/assets/images/icons/icon-tick-orange.svg");
const _imports_4 = publicAssetsURL("/assets/images/icons/icon-close.svg");
const _sfc_main$2 = {
  __name: "Section9",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</span><span class="text-sm font-bold text-gray-400 ml-[2px]">/month</span></div><h5 class="text-heading-5 font-chivo font-bold mb-[9px]">Standard</h5><p class="text-sm font-bold text-gray-400 mb-[43px]">All the basics for businesses that are just getting started.</p><div class="w-full bg-gray-300 h-[1px] mb-[21px]"></div><ul class="mb-[76px]"><li class="flex items-center gap-[10px] mb-[17px]"><img class="tick-icon"${ssrRenderAttr("src", _imports_2)} alt="icon"><img class="hidden tick-icon-active"${ssrRenderAttr("src", _imports_3)} alt="icon"><span class="text-md text-gray-500">Unlimited updates</span></li><li class="flex items-center gap-[10px] mb-[17px]"><img class="tick-icon"${ssrRenderAttr("src", _imports_2)} alt="icon"><img class="hidden tick-icon-active"${ssrRenderAttr("src", _imports_3)} alt="icon"><span class="text-md text-gray-500">Custom permissions</span></li><li class="flex items-center gap-[10px] mb-[17px]"><img${ssrRenderAttr("src", _imports_4)} alt="icon"><span class="text-md text-gray-500">Custom designs &amp; features</span></li></ul></div><button type="button">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="block text-inherit w-full h-full rounded-md text-lg font-chivo font-semibold"${_scopeId}>Get Started</span><i${_scopeId}><img class="ml-[7px] w-[12px] filter-white group-hover:filter-black"${ssrRenderAttr("src", _imports_0$2)} alt="arrow right icon"${_scopeId}></i>`);
          } else {
            return [
      ...
      _push(`</span></div><h5 class="text-heading-5 font-chivo font-bold mb-[9px]">Essentials</h5><p class="text-sm font-bold text-gray-400 mb-[43px]">All the basics for businesses that are just getting started.</p><div class="w-full bg-gray-300 h-[1px] mb-[21px]"></div><ul class="mb-[76px]"><li class="flex items-center gap-[10px] mb-[17px]"><img${ssrRenderAttr("src", _imports_2)} alt="icon"><span class="text-md text-gray-500">Unlimited updates</span></li><li class="flex items-center gap-[10px] mb-[17px]"><img${ssrRenderAttr("src", _imports_2)} alt="icon"><span class="text-md text-gray-500">Custom permissions</span></li><li class="flex items-center gap-[10px] mb-[17px]"><img${ssrRenderAttr("src", _imports_4)} alt="icon"><span class="text-md text-gray-500">Custom designs &amp; features</span></li><li class="flex items-center gap-[10px] mb-[17px]"><img${ssrRenderAttr("src", _imports_4)} alt="icon"><span class="text-md text-gray-500">Custom designs &amp; features</span></li></ul></div><button type="button">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        class: "flex items-center z-10 relative transition-all duration-200 group py-[11px] px-[22px] rounded-md bg-gray-900 text-white hover:bg-gray-100 hover:text-gray-900 border-[2px] border-[#171B24]",
        to: "#"
      }, {
      ...
      _push(`</span></div><h5 class="text-heading-5 font-chivo font-bold mb-[9px]">Premium</h5><p class="text-sm font-bold text-gray-400 mb-[43px]">Avanced features for pros who need more customization.</p><div class="w-full bg-gray-300 h-[1px] mb-[21px]"></div><ul class="mb-[76px]"><li class="flex items-center gap-[10px] mb-[17px]"><img class="tick-icon"${ssrRenderAttr("src", _imports_2)} alt="icon"><img class="hidden tick-icon-active"${ssrRenderAttr("src", _imports_3)} alt="icon"><span class="text-md text-gray-500">Unlimited updates</span></li><li class="flex items-center gap-[10px] mb-[17px]"><img class="tick-icon"${ssrRenderAttr("src", _imports_2)} alt="icon"><img class="hidden tick-icon-active"${ssrRenderAttr("src", _imports_3)} alt="icon"><span class="text-md text-gray-500">Custom permissions</span></li><li class="flex items-center gap-[10px] mb-[17px]"><img${ssrRenderAttr("src", _imports_4)} alt="icon"><span class="text-md text-gray-500">Custom designs &amp; features</span></li></ul></div><button type="button">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        class: "flex items-center z-10 relative transition-all duration-200 group py-[11px] px-[22px] rounded-md bg-gray-900 text-white hover:bg-gray-100 hover:text-gray-900 border-[2px] border-[#171B24]",
        to: "#"
      }, {
      ...
      _push(`</button></div><div class="rounded-2xl p-[35px] bg-white flex flex-col justify-between transition-all duration-300 package-card bill-annually"><div><div class="mb-[21px]"><span class="text-heading-3 font-bold font-chivo">$420</span><span class="text-sm font-bold text-gray-400 ml-[2px]">/year</span></div><h5 class="text-heading-5 font-chivo font-bold mb-[9px]">Standard</h5><p class="text-sm font-bold text-gray-400 mb-[43px]">All the basics for businesses that are just getting started.</p><div class="w-full bg-gray-300 h-[1px] mb-[21px]"></div><ul class="mb-[76px]"><li class="flex items-center gap-[10px] mb-[17px]"><img class="tick-icon"${ssrRenderAttr("src", _imports_2)} alt="icon"><img class="hidden tick-icon-active"${ssrRenderAttr("src", _imports_3)} alt="icon"><span class="text-md text-gray-500">Unlimited updates</span></li><li class="flex items-center gap-[10px] mb-[17px]"><img class="tick-icon"${ssrRenderAttr("src", _imports_2)} alt="icon"><img class="hidden tick-icon-active"${ssrRenderAttr("src", _imports_3)} alt="icon"><span class="text-md text-gray-500">Custom permissions</span></li><li class="flex items-center gap-[10px] mb-[17px]"><img${ssrRenderAttr("src", _imports_4)} alt="icon"><span class="text-md text-gray-500">Custom designs &amp; features</span></li></ul></div><button type="button">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        class: "flex items-center z-10 relative transition-all duration-200 group py-[11px] px-[22px] rounded-md bg-gray-900 text-white hover:bg-gray-100 hover:text-gray-900 border-[2px] border-[#171B24]",
        to: "#"
      }, {
      ...
      _push(`</button></div><div class="rounded-2xl p-[35px] bg-white bill-annually flex flex-col justify-between"><div><div class="mb-[21px]"><span class="text-heading-3 font-bold font-chivo">$1068</span><span class="text-sm font-bold text-gray-400 ml-[2px]">/year</span></div><h5 class="text-heading-5 font-chivo font-bold mb-[9px]">Essentials</h5><p class="text-sm font-bold text-gray-400 mb-[43px]">All the basics for businesses that are just getting started.</p><div class="w-full bg-gray-300 h-[1px] mb-[21px]"></div><ul class="mb-[76px]"><li class="flex items-center gap-[10px] mb-[17px]"><img${ssrRenderAttr("src", _imports_2)} alt="icon"><span class="text-md text-gray-500">Unlimited updates</span></li><li class="flex items-center gap-[10px] mb-[17px]"><img${ssrRenderAttr("src", _imports_2)} alt="icon"><span class="text-md text-gray-500">Custom permissions</span></li><li class="flex items-center gap-[10px] mb-[17px]"><img${ssrRenderAttr("src", _imports_4)} alt="icon"><span class="text-md text-gray-500">Custom designs &amp; features</span></li><li class="flex items-center gap-[10px] mb-[17px]"><img${ssrRenderAttr("src", _imports_4)} alt="icon"><span class="text-md text-gray-500">Custom designs &amp; features</span></li></ul></div><button type="button">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        class: "flex items-center z-10 relative transition-all duration-200 group py-[11px] px-[22px] rounded-md bg-gray-900 text-white hover:bg-gray-100 hover:text-gray-900 border-[2px] border-[#171B24]",
        to: "#"
      }, {
      ...
      _push(`</button></div><div class="rounded-2xl p-[35px] bg-white flex flex-col justify-between transition-all duration-300 package-card col-span-1 bill-annually md:col-span-2 lg:col-span-1"><div><div class="mb-[21px]"><span class="text-heading-3 font-bold font-chivo">$1500</span><span class="text-sm font-bold text-gray-400 ml-[2px]">/year</span></div><h5 class="text-heading-5 font-chivo font-bold mb-[9px]">Premium</h5><p class="text-sm font-bold text-gray-400 mb-[43px]">Avanced features for pros who need more customization.</p><div class="w-full bg-gray-300 h-[1px] mb-[21px]"></div><ul class="mb-[76px]"><li class="flex items-center gap-[10px] mb-[17px]"><img class="tick-icon"${ssrRenderAttr("src", _imports_2)} alt="icon"><img class="hidden tick-icon-active"${ssrRenderAttr("src", _imports_3)} alt="icon"><span class="text-md text-gray-500">Unlimited updates</span></li><li class="flex items-center gap-[10px] mb-[17px]"><img class="tick-icon"${ssrRenderAttr("src", _imports_2)} alt="icon"><img class="hidden tick-icon-active"${ssrRenderAttr("src", _imports_3)} alt="icon"><span class="text-md text-gray-500">Custom permissions</span></li><li class="flex items-center gap-[10px] mb-[17px]"><img${ssrRenderAttr("src", _imports_4)} alt="icon"><span class="text-md text-gray-500">Custom designs &amp; features</span></li></ul></div><button type="button">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        class: "flex items-center z-10 relative transition-all duration-200 group py-[11px] px-[22px] rounded-md bg-gray-900 text-white hover:bg-gray-100 hover:text-gray-900 border-[2px] border-[#171B24]",
        to: "#"
      }, {
...
//# sourceMappingURL=index-F23_YcaO.mjs.map
