...
import { _ as _imports_2 } from './virtual_public-D4tZ-TSE.mjs';
import { _ as _imports_3$1 } from './virtual_public-DWqgV7xc.mjs';
import { p as publicAssetsURL } from '../routes/renderer.mjs';
import { _ as _imports_0, a as _imports_1$1, b as _imports_2$1, c as _imports_3$2, d as _imports_4$1, e as _imports_5, f as _imports_7 } from './virtual_public-DoPwShJ5.mjs';
import { _ as _imports_0$1 } from './virtual_public-Dje3ZdMY.mjs';
import { _ as _imports_0$2 } from './virtual_public-Bu2XTia_.mjs';
import { _ as _imports_2$2 } from './virtual_public-Cet6Xz5C.mjs';
import { _ as _imports_0$3 } from './virtual_public-DWP5uY88.mjs';
import { _ as _imports_3$3 } from './virtual_public-6U-jVfO3.mjs';
import { _ as _imports_0$4 } from './virtual_public-9znkGGCe.mjs';
import { _ as _imports_4$2 } from './virtual_public-BUWQ-iTC.mjs';
import { _ as _imports_0$5 } from './virtual_public-edIg6YOR.mjs';
import { _ as _imports_0$6 } from './virtual_public-DTZSeK32.mjs';
import { _ as _imports_2$3, a as _imports_3$4 } from './virtual_public-D05v_FUI.mjs';
import { _ as __nuxt_component_0$2 } from './Testimonial1-Bce7avcF.mjs';
import { _ as _imports_0$7, a as _imports_1$2 } from './virtual_public-BzD1hskI.mjs';
...
const _imports_3 = publicAssetsURL("/assets/images/icons/icon-anchor.svg");
const _imports_4 = publicAssetsURL("/assets/images/hero-about2.png");
const _sfc_main$7 = {};
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$1;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "full-width bg-bg-2" }, _attrs))}><div class="px-[12px] md:px-[36px] xl:px-0 mt-0 z-10 relative mx-auto py-[60px] max-w-[1320px] lg:flex lg:items-end lg:justify-between"><div class="lg:w-[60%] lg:mr-[150px]"><span class="font-chivo inline-block bg-bg-6 text-green-900 py-[14px] px-[28px] rounded-[50px] text-[14px] leading-[14px] mb-[10px]">What We Do, What You Get</span><h1 class="font-chivo font-bold lg:text-display-2 md:text-[64px] md:leading-[70px] sm:text-[50px] sm:leading-[58px] text-[40px] leading-[48px] mb-[30px]">Advanced analytics to grow your business</h1><p class="text-quote md:text-lead-lg text-gray-500 relative z-10 pr-[40px] lg:pr-[60px] mb-[44px]">Integrated workflow designed for product teams. We create world-class development and branding</p><div class="flex items-center justify-start mb-[50px]"><button type="button">`);
  ...
  _push(`<i><img class="ml-[7px] w-[12px]"${ssrRenderAttr("src", _imports_1)} alt="arrow right icon"></i></div></div><div class="relative"><div class="flex justify-between w-full flex-wrap lg:flex-col gap-[40px] lg:gap-0"><div class="flex items-start lg:mb-[60px] last:mb-0 gap-[26px]"><div class="bg-white rounded-full w-[80px] h-[80px]"><img class="h-full w-full object-cover p-[18px]"${ssrRenderAttr("src", _imports_2)} alt="icon"></div><div class="flex-1"><h2 class="font-bold font-chivo text-[25px] leading-[30px] md:text-heading-3 text-green-900 mb-[5px]">+12k</h2><p class="text-text text-gray-500">Projects done</p></div></div><div class="flex items-start lg:mb-[60px] last:mb-0 gap-[26px]"><div class="bg-white rounded-full w-[80px] h-[80px]"><img class="h-full w-full object-cover p-[18px]"${ssrRenderAttr("src", _imports_3$1)} alt="icon"></div><div class="flex-1"><h2 class="font-bold font-chivo text-[25px] leading-[30px] md:text-heading-3 text-green-900 mb-[5px]">+68</h2><p class="text-text text-gray-500">Offices / Factories</p></div></div><div class="flex items-start lg:mb-[60px] last:mb-0 gap-[26px]"><div class="bg-white rounded-full w-[80px] h-[80px]"><img class="h-full w-full object-cover p-[18px]"${ssrRenderAttr("src", _imports_3)} alt="icon"></div><div class="flex-1"><h2 class="font-bold font-chivo text-[25px] leading-[30px] md:text-heading-3 text-green-900 mb-[5px]">+15k</h2><p class="text-text text-gray-500">Constant clients</p></div></div></div><div class="absolute hidden bottom-[-60px] left-[-117px] translate-x-[-260px] lg:block"><img class="h-full w-full object-cover animate-hero-thumb-sm-animation"${ssrRenderAttr("src", _imports_4)} alt="Agon"></div></div></div></div>`);
}
const _sfc_setup$7 = _sfc_main$7.setup;
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/About2/Section1.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$6]]);
const _sfc_main$6 = {};
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "px-[12px] md:px-[36px] xl:px-0 mt-[70px] text-center mx-auto max-w-[905px]" }, _attrs))}><span class="font-chivo inline-block bg-bg-2 text-orange-900 py-[14px] px-[28px] rounded-[50px] text-[14px] leading-[14px] mb-4">How It Work ?</span><div class="text-center mb-[88px]"><h2 class="font-bold font-chivo mx-auto text-[35px] leading-[44px] md:text-[46px] md:leading-[52px] lg:text-heading-1 text-gray-900 mb-5 md:mb-[30px] max-w-[725px]">Cross-border ordering has never been easier</h2><p class="text-quote md:text-lead-lg text-gray-600 mx-auto max-w-[976px]"></p></div><div class="flex flex-col gap-5 items-center justify-center relative md:flex-wrap md:flex-row lg:gap-[30px] xl:gap-[110px]"><div class="rounded-2xl p-[30px] md:py-[20px] md:px-[53px] self-stretch relative bg-bg-2 md:w-[calc(50%-20px)] lg:w-[calc(33.33%-30px)] xl:w-[calc(33.33%-75px)] transition-all duration-300 hover:translate-y-[-3px]"><div class="bg-white rounded-full grid place-items-center mx-auto mb-8 w-[80px] h-[80px]"><img class="max-w-[36px]"${ssrRenderAttr("src", _imports_0)} alt="icon"></div><h4 class="font-bold font-chivo text-[14px] xl:text-heading-5 mb-[15px]">Start Plan</h4><p class="text-text text-gray-500">Choose any of our packages</p><img class="hidden absolute right-0 lg:block top-1/2 translate-x-[30px] z-[-1] xl:translate-x-full xl:right-[-15px]"${ssrRenderAttr("src", _imports_1$1)} alt="direction arrow"></div><div class="rounded-2xl p-[30px] md:py-[20px] md:px-[53px] self-stretch relative bg-bg-3 md:w-[calc(50%-20px)] lg:w-[calc(33.33%-30px)] xl:w-[calc(33.33%-75px)] transition-all duration-300 hover:translate-y-[-3px]"><div class="bg-white rounded-full grid place-items-center mx-auto mb-8 w-[80px] h-[80px]"><img class="max-w-[36px]"${ssrRenderAttr("src", _imports_2$1)} alt="icon"></div><h4 class="font-bold font-chivo text-[14px] xl:text-heading-5 mb-[15px]">Connect</h4><p class="text-text text-gray-500">Receive concepts In 24 hours</p><img class="hidden absolute right-0 lg:block top-1/2 translate-x-[30px] z-[-1] xl:translate-x-full xl:right-[-15px]"${ssrRenderAttr("src", _imports_3$2)} alt="direction arrow"></div><div class="rounded-2xl p-[30px] md:py-[20px] md:px-[53px] self-stretch relative bg-bg-5 md:w-[calc(50%-20px)] lg:w-[calc(33.33%-30px)] xl:w-[calc(33.33%-75px)] transition-all duration-300 hover:translate-y-[-3px]"><div class="bg-white rounded-full grid place-items-center mx-auto mb-8 w-[80px] h-[80px]"><img class="max-w-[36px]"${ssrRenderAttr("src", _imports_4$1)} alt="icon"></div><h4 class="font-bold font-chivo text-[14px] xl:text-heading-5 mb-[15px]">Match</h4><p class="text-text text-gray-500">Development Stage</p><img class="hidden absolute right-0 top-full lg:block translate-x-[-60px] z-[-1] xl:translate-y-[30px]"${ssrRenderAttr("src", _imports_5)} alt="direction arrow"></div><div class="rounded-2xl p-[30px] md:py-[20px] md:px-[53px] self-stretch relative bg-bg-9 md:w-[calc(50%-20px)] lg:w-[calc(33.33%-30px)] xl:w-[calc(33.33%-75px)] transition-all duration-300 hover:translate-y-[-3px] lg:order-1"><div class="bg-white rounded-full grid place-items-center mx-auto mb-8 w-[80px] h-[80px]"><img class="max-w-[36px]"${ssrRenderAttr("src", _imports_0$1)} alt="icon"></div><h4 class="font-bold font-chivo text-[14px] xl:text-heading-5 mb-[15px]">Review</h4><p class="text-text text-gray-500">Project launch and checkout</p><img class="hidden absolute left-0 lg:block top-1/2 translate-x-[-30px] z-[-1] xl:-translate-x-full xl:left-[-15px]"${ssrRenderAttr("src", _imports_7)} alt="direction arrow"></div><div class="rounded-2xl p-[30px] md:py-[20px] md:px-[53px] self-stretch relative bg-bg-5 md:w-[calc(50%-20px)] lg:w-[calc(33.33%-30px)] xl:w-[calc(33.33%-75px)] transition-all duration-300 hover:translate-y-[-3px]"><div class="bg-white rounded-full grid place-items-center mx-auto mb-8 w-[80px] h-[80px]"><img class="max-w-[36px]"${ssrRenderAttr("src", _imports_0$2)} alt="icon"></div><h4 class="font-bold font-chivo text-[14px] xl:text-heading-5 mb-[15px]">Complete</h4><p class="text-text text-gray-500">After-release Support</p></div></div></div>`);
}
const _sfc_setup$6 = _sfc_main$6.setup;
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/About2/Section2.vue");
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$1;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "full-width bg-green-900" }, _attrs))}><div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] flex items-center mx-auto lg:mt-[150px] py-[96px] gap-[50px] max-w-[1320px]"><div class="hidden grid-cols-2 grid-rows-2 flex-1 gap-5 lg:grid"><div><img class="h-full w-full object-cover rounded-2xl"${ssrRenderAttr("src", _imports_2$2)} alt="Agon"></div><div class="col-start-1 row-start-2"><img class="h-full w-full object-cover rounded-2xl"${ssrRenderAttr("src", _imports_0$3)} alt="Agon"></div><div class="col-start-2 row-span-2"><img class="h-full w-full object-cover rounded-2xl"${ssrRenderAttr("src", _imports_3$3)} alt="Agon"></div></div><div class="flex-1"><h1 class="font-chivo text-[35px] leading-[44px] sm:text-[46px] sm:leading-[52px] md:text-heading-1 font-extrabold text-white mb-[26px]">Our game-changing approach to working together</h1><p class="text-text mb-9 text-[#D1DAE4]">Check out stories from companies like Leroy Merlin and Decathlon to get inspired by how much you can gain.</p><button type="button">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    class: "flex items-center z-10 relative transition-all duration-200 group px-[22px] py-[15px] lg:px-[32px] lg:py-[22px] rounded-[50px] bg-gray-900 text-white hover:bg-gray-100 hover:text-gray-900 text-text w-fit",
    to: "#"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<span class="block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold"${_scopeId}>I am Button</span>`);
      } else {
        return [
          createVNode("span", { class: "block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold" }, "I am Button")
        ];
      }
    }),
    _: 1
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/About2/Section3.vue");
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$1;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "px-[12px] md:px-[36px] xl:px-0 mt-[70px] lg:mt-[138px]" }, _attrs))}><div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between mb-[45px] md:mb-[87px]"><div><h2 class="text-gray-900 font-bold font-chivo mb-5 text-[35px] leading-[44px] md:text-[46px] md:leading-[52px] lg:text-heading-1 md:mb-[30px] max-w-[725px]">Learn about us</h2><p class="text-quote md:text-lead-lg text-gray-600">Know more about our potentiality</p></div><button type="button">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/About2/Section4.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "px-[12px] md:px-[36px] xl:px-0 mt-[70px] lg:mt-[128px]" }, _attrs))}><div class="items-center justify-between md:flex mb-[30px] md:mb-[90px]"><div class="mb-8"><h2 class="text-gray-900 font-bold font-chivo mb-5 text-[35px] leading-[44px] md:text-[46px] md:leading-[52px] lg:text-heading-1 md:mb-[30px] max-w-[725px]">Our Happy Customers</h2><p class="text-quote md:text-lead-lg text-gray-600">Know about our clients, we are a woldwide corporate brand</p></div><div class="flex items-center gap-5"><div class="place-items-center border border-gray-200 bg-gray-100 rounded-full cursor-pointer group transition-colors duration-200 w-[48px] xl:w-[64px] h-[48px] xl:h-[64px] hover:bg-gray-900 feedback-prev grid"><img class="group-hover:filter-white"${ssrRenderAttr("src", _imports_0$7)} alt="control icon button"></div><div class="place-items-center border border-gray-200 bg-gray-100 rounded-full cursor-pointer group transition-colors duration-200 w-[48px] xl:w-[64px] h-[48px] xl:h-[64px] hover:bg-gray-900 feedback-next grid"><img class="group-hover:filter-white"${ssrRenderAttr("src", _imports_1$2)} alt="control icon button"></div></div></div>`);
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/About2/Section7.vue");
...
const _sfc_main = {
  ...
  setup(__props) {
    useHead({
      bodyAttrs: {
        class: "overflow-x-hidden w-screen relative about-2-page"
      }
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_SectionsAbout2Section1 = __nuxt_component_0;
      const _component_SectionsAbout2Section2 = __nuxt_component_1;
      const _component_SectionsAbout2Section3 = __nuxt_component_2;
      const _component_SectionsAbout2Section4 = __nuxt_component_3;
      const _component_SectionsAbout2Section5 = __nuxt_component_4;
      const _component_SectionsAbout2Section6 = __nuxt_component_5;
      const _component_SectionsAbout2Section7 = __nuxt_component_6;
      _push(`<div${ssrRenderAttrs(_attrs)}>`);
      _push(ssrRenderComponent(_component_SectionsAbout2Section1, null, null, _parent));
      _push(ssrRenderComponent(_component_SectionsAbout2Section2, null, null, _parent));
      _push(ssrRenderComponent(_component_SectionsAbout2Section3, null, null, _parent));
      _push(ssrRenderComponent(_component_SectionsAbout2Section4, null, null, _parent));
      _push(ssrRenderComponent(_component_SectionsAbout2Section5, null, null, _parent));
      _push(ssrRenderComponent(_component_SectionsAbout2Section6, null, null, _parent));
      _push(ssrRenderComponent(_component_SectionsAbout2Section7, null, null, _parent));
      _push(`</div>`);
    };
  }
};
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/about-2/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-OlBaJVdZ.mjs.map
