...
const _routes = [
  {
    name: "slug",
    path: "/:slug()",
    component: () => import('./_slug_-DNiv2bcl.mjs')
  },
  {
    name: "about-backup",
    path: "/about/backup",
...
const _imports_2 = publicAssetsURL("/assets/images/icons/icon-right.svg");
const _sfc_main$1 = {
  __name: "error",
