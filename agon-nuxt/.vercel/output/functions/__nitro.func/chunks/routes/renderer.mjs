...
import { a as defineRenderHandler, b as buildAssetsURL, p as publicAssetsURL, g as getQuery, c as createError, e as getRouteRules, u as useRuntimeConfig, f as useNitroApp, h as getResponseStatusText, i as getResponseStatus } from '../nitro/nitro.mjs';
...
const appHead = {"link":[{"rel":"icon","href":"/favicon-16x16.png","type":"image/png","sizes":"16x16"},{"rel":"icon","href":"/favicon-32x32.png","type":"image/png","sizes":"32x32"},{"rel":"apple-touch-icon","href":"/apple-touch-icon.png","type":"image/png","sizes":"180x180"}],"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"property":"og:type","content":"website"}],"style":[],"script":[],"noscript":[],"title":"Agon - Multipurpose Agency TailwindCSS NuxtJS Template","titleTemplate":"%s %seperator %siteName","templateParams":{"seperator":"—","siteName":"MySite"},"htmlAttrs":{}};
