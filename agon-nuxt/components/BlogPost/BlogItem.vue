<template>
    <div class="lg:grid lg:grid-cols-3 lg:gap-x-5 xl:gap-x-[30px] gap-y-[50px] xl:gap-y-[87px]">
        <NuxtLink v-for="blog in blogPostData" :key="blog.id" class="block group" :to="`blog-details/${blog.slug}`">
...
// console.log('Blog Slugs:', blogPostData.value.map(blog => blog.slug));
