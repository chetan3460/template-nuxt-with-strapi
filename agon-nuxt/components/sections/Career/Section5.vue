<template>
    <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] lg:mt-[138px]">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between mb-[45px] md:mb-[87px]">
            ...
            <button type="button">
                <NuxtLink
                    ...
                    to="#"><span
                        class="block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold">View
                        More</span><i> <img class="ml-[7px] w-[12px] filter-white group-hover:filter-black"
        ...
        <div class="rounded-2xl p-[30px] md:py-[53px] md:px-[48px] gap-5 mx-auto bg-orange-100 md:flex lg:gap-[40px] lg:h-[420px] xl:h-[390px] max-w-[1190px] mt-[150px]"
            ...
            <div class="flex-1 mb-[30px]">
                ...
                <h4 class="font-bold font-chivo text-[28px] leading-[32px] md:text-heading-2 mb-[20px]">Subscribe our
                    newsletter</h4>
