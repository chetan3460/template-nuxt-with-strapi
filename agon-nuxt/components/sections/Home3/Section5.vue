<template>
    <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px]">
        <div class="gap-6 px-5 lg:flex xl:gap-[50px]">
            <div class="flex-1 mb-[40px]">
                ...
                <p class="text-text text-gray-600 mb-[40px]">Feeling inquisitive? Have a read through some of our
                    FAQs or contact our supporters for help
                </p>
                <div class="flex flex-col lg:max-w-[303px] md:gap-[35px] lg:mb-[48px]">
                    <div class="mb-[30px] lg:mb-0">
                        ...
                        <p class="text-excerpt text-gray-600">The latest design trends meet hand-crafted templates.
                        </p>
                    </div>
                    <div class="mb-[30px] lg:mb-0">
                        <div class="flex items-center mb-[17px]"><img class="mr-[9px]"
                ...
                <div class="flex items-center">
                    <button type="button">
                        <NuxtLink
                            ...
                            to="#"><span
                                class="block text-inherit w-full h-full rounded-[50px] text-lg font-chivo font-semibold">Contact
                                Us</span><i> <img class="ml-[7px] w-[12px] filter-white group-hover:filter-black"
                    ...
                    <button type="button">
                        <NuxtLink
                            ...
                            to="#"><span
                                class="block text-inherit w-full h-full rounded-md text-lg font-chivo font-semibold">Support
                                Center</span></NuxtLink>
                    </button>
                </div>
            </div>
            <div class="flex-[1.5]">
                <div class="relative accordion-item mb-5">
                    <details>
                        <summary class="flex justify-between py-5 items-center gap-5 px-[30px]">
                            <h4 class="font-bold font-chivo text-[14px] xl:text-heading-5">Where is my order?
                                Quisque molestie
                            </h4>
                        </summary>
                        <p class="text-text content font-chivo mt-[30px] ml-[30px]">Nulla non sollicitudin. Morbi
                            sit amet laoreet ipsum, vel pretium mi. Morbi varius, tellus in accumsan blandit, elit
                            ligula eleifend velit, luctus mattis ante nulla condimentum nulla.
                        </p>
                    </details>
                </div>
                <div class="relative accordion-item mb-5">
                ...
                <div class="relative accordion-item mb-5">
                    <details>
                        <summary class="flex justify-between py-5 items-center gap-5 px-[30px]">
                            <h4 class="font-bold font-chivo text-[14px] xl:text-heading-5">What are the delivery
                                types you use?
                            </h4>
                        </summary>
                        <p class="text-text content font-chivo mt-[30px] ml-[30px]">Nulla non sollicitudin. Morbi
