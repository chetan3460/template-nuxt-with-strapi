<template>
    <div class="px-[12px] md:px-[36px] xl:px-0 mt-[70px] flex flex-col gap-8 lg:mt-[136px] lg:flex-row xl:gap-[88px]">
        <div>
            <h1
                class="font-chivo text-[35px] leading-[44px] sm:text-[46px] sm:leading-[52px] md:text-heading-1 font-extrabold mb-[28px]">
                How It Works
            </h1>
            <p class="text-excerpt text-gray-600">Ac sapien purus tristique neque nibh vitae faucibus non phasellus
                vulputate nulla in eget amet, risus</p>
        </div>
        <div class="lg:flex lg:items-center gap-[30px]">
            <div
                ...
                <img class="h-full w-full object-cover max-w-[64px]" src="/assets/images/icons/icon-resources.svg"
                    alt="icon">
                <div>
